...
if type(active_theme) ~= "string" or active_theme == "" then
...
if active_theme == "dms" then
  -- DMS/matugen generated theme. The colorscheme file is generated locally by
  -- ~/.config/matugen/templates/nvim-dms.lua.
  return {
    {
      "LazyVim/LazyVim",
      opts = {
...
elseif is_custom_theme(active_theme) then
...
elseif
  active_theme == "sonokai"
  or active_theme == "sonokai-default"
  or active_theme == "sonokai-atlantis"
  or active_theme == "sonokai-andromeda"
  or active_theme == "sonokai-shusia"
  or active_theme == "sonokai-maia"
  or active_theme == "sonokai-espresso"
then
...
elseif active_theme == "carbonfox" then
  ...
  local plugin_name = theme_plugins[active_theme]
  local colorscheme = active_theme

  if not plugin_name then
    plugin_name = "sainnhe/gruvbox-material"
    colorscheme = "gruvbox-material"
    vim.schedule(function()
      vim.notify(
        ("Unknown theme %q; falling back to gruvbox-material"):format(tostring(active_theme)),
        vim.log.levels.WARN,
