-- Migrated from HYDE - Vertical.conf to the Hyprland 0.55+ Lua config format.
-- Name: Vertical
...
-- Workspaces
-- hl.animation({ leaf = "workspaces", enabled = true, speed = 3, bezier = "fluent_decel", style = "slidefade 30%" }) -- styles: slide, slidevert, fade, slidefade, slidefadevert
